...
CSV_FILE_PATH = "/home/x3raspian/Falconia/data_management/data/aggregate.csv"
...
def write_to_csv(data):
    ...
    try:
        ...
        print(f"Writing to file: {CSV_FILE_PATH}")  # Debugging output
...
def sensor_monitor():
    ...
    while True:
        try:
            ...
            print(f"Error in sensor_monitor: {e}")
